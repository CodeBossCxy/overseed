    ...
    return (
      <MainLayout>
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          ...
          <p className="text-gray-600 text-lg mb-8">{t.contact.successMessage}</p>
          <Link href="/"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-10">{t.contact.subtitle}</p>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm mt-1">{t.contact.emailDesc}</p>
                  <a href="mailto:contact@overseed.net" className="text-primary-600 hover:text-primary-700 font-medium mt-1 inline-block">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">{t.contact.businessTitle}</h3>
                  <p className="text-gray-600 text-sm mt-1">{t.contact.businessDesc}</p>
                  <a href="mailto:business@overseed.net" className="text-primary-600 hover:text-primary-700 font-medium mt-1 inline-block">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">{t.contact.responseTitle}</h3>
                  <p className="text-gray-600 text-sm mt-1">{t.contact.responseDesc}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">{t.contact.companyLabel}</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">{t.contact.inquiryLabel} *</label>
                <select
                  required
