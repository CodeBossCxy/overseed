...
export default function Footer() {
  ...
  return (
    <footer className="text-white/70 mt-auto relative" style={{ backgroundColor: 'rgba(2, 10, 24, 0.95)', backdropFilter: 'blur(20px)', borderTop: '1px solid rgba(212, 224, 253, 0.08)' }}>
